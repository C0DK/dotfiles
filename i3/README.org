...
#+BEGIN_SRC Conf[Space]
set $mode_open (e)ditor, (t)erm, (b)rowser, (s)potify, (Shift+s)kype, (m)essenger, (k)eybase, (p)dfreader, (Shift+p)ass, (Shift+m)ail, (c)hrome
mode "$mode_open" {
...
for_window [instance="forceFloat"] floating enable move scratchpad border normal sticky enable
