...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, BACKLIT, KC_LALT, KC_LGUI, TT(_LOWER),   KC_SPC,  KC_SPC,  TT(_RAISE),   KC_LALT, KC_RALT, G(KC_O), MO(_ADJUST) \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F12,  RESET,   DEBUG,   _______,     _______, _______, TERM_ON,     TERM_OFF, _______, _______, KC_DEL,  \
